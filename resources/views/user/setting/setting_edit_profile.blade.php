                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('user.update_profile') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <img class="rounded avatar-lg" src="{{ $auth_user->profile_image ?  asset('storage/user_images\/') . $auth_user->profile_image : asset('images/no-image.jpg') }}" alt="Card image cap" id="showImage">    
                                </div>
                            </div>
                            <!-- end row -->
