        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block user-dropdown">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    <img class="rounded-circle header-profile-user" src="{{ Auth::guard('admin')->user()->image ?  asset('storage/admin_images\/') . Auth::guard('admin')->user()->image : asset('images/no-image.jpg') }}"
                        alt="Header Avatar">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    {{-- <a class="dropdown-item" href="{{ route('admin.password.edit') }}"><i class="ri-lock-password-line align-middle me-1"></i> Change Password</a> --}}
